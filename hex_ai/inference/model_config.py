...
MODEL_GENERATIONS: Dict[int, Dict[str, Any]] = {
    ...
    54: {
        ...
        "models": ["epoch164_mini13.pt.gz", "epoch164_mini22.pt.gz", "epoch163_mini64.pt.gz", "epoch163_mini104.pt.gz", "epoch163_mini75.pt.gz", "epoch164_mini15.pt.gz", "epoch162_mini30.pt.gz", "epoch163_mini104.pt.gz"]
    },
}
