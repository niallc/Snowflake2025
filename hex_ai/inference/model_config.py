...
MODEL_GENERATIONS: Dict[int, Dict[str, Any]] = {
    ...
    38: {
        "dir": "hyperparameter_tuning/pipeline_20251214_230526/",
        "models": ["epoch121_mini38.pt.gz"]
    },
    39: {
        "dir": "hyperparameter_tuning/pipeline_20251218_104145/",
        "models": ["epoch123_mini58.pt.gz"]
    },
    40: {
        "dir": "hyperparameter_tuning/pipeline_20251219_110901/",
        "models": ["epoch127_mini2.pt.gz", "epoch127_mini59.pt.gz", "epoch126_mini23.pt.gz", "epoch124_mini54.pt.gz"]
    },
    41: {
        "dir": "hyperparameter_tuning/pipeline_20251224_112429/",
        "models": ["epoch130_mini70.pt.gz", "epoch129_mini89.pt.gz", "epoch130_mini72.pt.gz"]
    },
    42: {
        "dir": "hyperparameter_tuning/pipeline_20251229_182959/",
        "models": ["epoch133_mini33.pt.gz", "epoch133_mini56.pt.gz", "epoch133_mini45.pt.gz"]
    },
    43: {
        "dir": "hyperparameter_tuning/pipeline_20260104_121816/",
        "models": ["epoch135_mini111.pt.gz", "epoch136_mini6.pt.gz", "epoch135_mini40.pt.gz"]
    },
    44: {
        "dir": "hyperparameter_tuning/pipeline_20260108_134021/",
        "models": ["epoch138_mini22.pt.gz", "epoch139_mini1.pt.gz", "epoch138_mini45.pt.gz", "epoch138_mini98.pt.gz", "epoch138_mini112.pt.gz", "epoch138_mini106.pt.gz"]
    },
    45: {
    ...
    50: {
        ...
        "models": ["epoch153_mini32.pt.gz", "epoch154_mini21.pt.gz", "epoch153_mini69.pt.gz","epoch153_mini66.pt.gz"]
    },
    51: {
        "dir": "hyperparameter_tuning/pipeline_20260213_075354/",
        "models": ["epoch156_mini30.pt.gz", "epoch156_mini21.pt.gz", "epoch155_mini96.pt.gz", "epoch156_mini24.pt.gz", "epoch156_mini2.pt.gz"]
    },
    52: {
        "dir": "hyperparameter_tuning/pipeline_20260217_232105/",
        "models": ["epoch158_mini83.pt.gz", "epoch159_mini11.pt.gz", "epoch159_mini8.pt.gz", "epoch159_mini9.pt.gz", "epoch159_mini19.pt.gz"]
    },
    53: {
        "dir": "hyperparameter_tuning/pipeline_20260221_044357/",
        "models": ["epoch161_mini42.pt.gz", "epoch161_mini50.pt.gz", "epoch161_mini64.pt.gz"]
    },
    54: {
        "dir": "hyperparameter_tuning/pipeline_20260225_024817/",
        "models": ["epoch164_mini22.pt.gz", "epoch164_mini13.pt.gz", "epoch163_mini64.pt.gz", "epoch163_mini104.pt.gz", "epoch163_mini75.pt.gz", "epoch164_mini15.pt.gz", "epoch162_mini30.pt.gz", "epoch163_mini104.pt.gz"]
    },
    55: {
        "dir": "hyperparameter_tuning/pipeline_20260227_225222/",
        "models": ["epoch168_mini18.pt.gz", "epoch166_mini84.pt.gz"]
    },
    56: {
        "dir": "hyperparameter_tuning/pipeline_20260301_214656/",
        "models": ["epoch170_mini31.pt.gz", "epoch170_mini6.pt.gz", "epoch170_mini53.pt.gz", ]
    },
    57: {
        "dir": "hyperparameter_tuning/pipeline_20260303_173935/",
        "models": ["epoch172_mini25.pt.gz", "epoch172_mini2.pt.gz", "epoch171_mini40.pt.gz", "epoch173_mini13.pt.gz"]
    },
    58: {
        "dir": "hyperparameter_tuning/pipeline_20260305_152704/",
        "models": ["epoch175_mini3.pt.gz", "epoch175_mini5.pt.gz", "epoch175_mini6.pt.gz"]
    },
    59: {
        "dir": "hyperparameter_tuning/pipeline_20260306_231925/",
        "models": ["epoch177_mini31.pt.gz", "epoch177_mini22.pt.gz", "epoch178_mini9.pt.gz"]
    },
    60: {
    ...
    61: {
        ...
        "models": ["epoch181_mini12.pt.gz", "epoch180_mini37.pt.gz", "epoch180_mini25.pt.gz", "epoch180_mini38.pt.gz"]
    },
    62: {
        "dir": "hyperparameter_tuning/pipeline_20260311_185454/",
        "models": ["epoch184_mini24.pt.gz", "epoch183_mini17.pt.gz"]
    },
    63: {
        "dir": "hyperparameter_tuning/pipeline_20260313_205712/",
        "models": ["epoch188_mini2.pt.gz", "epoch187_mini45.pt.gz", "epoch187_mini9.pt.gz"]
    },
    64: {
    ...
    66: {
        ...
        "models": ["epoch4_mini16.pt.gz", "epoch4_mini14.pt.gz"]
    },
    67: {
        "dir": "hyperparameter_tuning/pipeline_20260325_044231/",
        "models": ["epoch5_mini16.pt.gz"]
    },
}
