...
# Removed test_determine_winner_and_swap_logic - function no longer exists

# Removed test_network_outputs_are_logits - select_move function no longer exists

# Removed test_handle_pie_rule_swap_and_no_swap - handle_pie_rule function no longer exists

# Removed test_select_move_policy_and_tree_search - select_move function no longer exists
